...
menu = {
    ...
    ordering_element = ui.new_combobox("RAGE", "Other", "H: Ordering element", {"Id", "Player", "Hitbox", "Hit chance", "Damage", "Backtrack", "Body yaw", "Flags"}),
    ...
    ord = {
        ui.new_combobox("RAGE", "Other", "H: Order 1", {"Id", "Player", "Hitbox", "Hit chance", "Damage", "Backtrack", "Body yaw", "Flags"}),
        ui.new_combobox("RAGE", "Other", "H: Order 2", {"Id", "Player", "Hitbox", "Hit chance", "Damage", "Backtrack", "Body yaw", "Flags"}),
        ui.new_combobox("RAGE", "Other", "H: Order 3", {"Id", "Player", "Hitbox", "Hit chance", "Damage", "Backtrack", "Body yaw", "Flags"}),
        ui.new_combobox("RAGE", "Other", "H: Order 4", {"Id", "Player", "Hitbox", "Hit chance", "Damage", "Backtrack", "Body yaw", "Flags"}),
        ui.new_combobox("RAGE", "Other", "H: Order 5", {"Id", "Player", "Hitbox", "Hit chance", "Damage", "Backtrack", "Body yaw", "Flags"}),
        ui.new_combobox("RAGE", "Other", "H: Order 6", {"Id", "Player", "Hitbox", "Hit chance", "Damage", "Backtrack", "Body yaw", "Flags"}),
        ui.new_combobox("RAGE", "Other", "H: Order 7", {"Id", "Player", "Hitbox", "Hit chance", "Damage", "Backtrack", "Body yaw", "Flags"}),
        ui.new_combobox("RAGE", "Other", "H: Order 8", {"Id", "Player", "Hitbox", "Hit chance", "Damage", "Backtrack", "Body yaw", "Flags"})
    }
}
